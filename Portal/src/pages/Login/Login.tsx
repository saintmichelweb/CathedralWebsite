...
import {
  ...
  TwoFactorAuthCodeSchema,
} from "../../lib/validations/twoFactorAuthCode";
        ...
        <Flex w="90vw" maxW="900px" rounded="xl" shadow="md" overflow="hidden">
          ...
          {showOtpComponent ? (
            <TwoFactorAuth
              ...
              setShowOtpComponent={(value: boolean) =>
                setShowOtpComponent(value)
              }
            />
          ) : (
            <Stack
...
const TwoFactorAuth = (props: TwoFactorAuthProps) => {
  ...
  const resendOtp = async () => {
    setIsPending(true);
    await login(props.userEmail, props.userPassword)
      .then(async () => {
        toast({
          title: "OTP message!",
